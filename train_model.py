...
parser.add_argument('--catego', type=bool, default=True, help='categorical')
...
def TrainTask(seed=0):
    ...
    table = datasets.LoadDmv(args.dataset, do_compression=args.compression, if_eval=args.catego)
